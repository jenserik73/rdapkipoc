...
resource oci_containerengine_cluster export_rdap-chatbot-oke-cluster {
  ...
  defined_tags = {
    ...
    "Oracle-Tags.CreatedOn" = "2026-05-29T10:19:13.443Z"
  }
  endpoint_config {
...
resource oci_containerengine_node_pool export_rdap-chatbot-oke-node-pool {
  cluster_id     = oci_containerengine_cluster.export_rdap-chatbot-oke-cluster.id
  compartment_id = oci_artifacts_container_configuration.export_container_configuration.id
  defined_tags = {
    "Oracle-Tags.CreatedBy" = "default/jens.erik.myhra@sykehuspartner.no"
    "Oracle-Tags.CreatedOn" = "2026-05-29T10:25:19.651Z"
  }
  freeform_tags = {
  }
  initial_node_labels {
  ...
  node_source_details {
    ...
    image_id    = var.oci_core_instance--source_details-source_id--export_oke-cburyzxciiq-nbwc7loxi5q-s7icahamozq-1_1
    source_type = "IMAGE"
  }
